...
namespace WOptiPNG
{
    //taken from https://stackoverflow.com/questions/358700/how-to-install-a-windows-service-programmatically-in-c
    ...
    public static class ServiceInstaller
    {
        ...
        private static IntPtr OpenSCManager(ScmAccessRights rights)
        {
            ...
            if (scm == IntPtr.Zero)
            {
                throw new ApplicationException(string.Format("Could not connect to service control manager: {0}", exception.Message));
            }
